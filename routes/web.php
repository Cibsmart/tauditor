...
Route::middleware('auth')->group(function () {
    Route::name('beneficiaries.')->group(function () {
        Route::get(':key="gender.id"', [BeneficiaryController::class, 'index'])->name('index');
        ...
        //Route::match(['GET','POST'],'/admin_articles_delivered','ArticleController@articles_delivered')->name('admin_articles_delivered');
