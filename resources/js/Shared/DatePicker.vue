<template>
                ...
                <div class="mb-5 w-64">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" readonly v-model="datepickerValue" @click="showDatepicker = !showDatepicker"
                            @keydown.escape="showDatepicker = false" placeholder="Select date" id="datepicker"
                        ...
                        <div class="bg-white mt-12 rounded-lg shadow p-4 absolute top-0 left-0" style="width: 17rem"
                            @click.away="showDatepicker = false"> <!-- x-show.transition="showDatepicker"  -->
                            ...
                            <div class="flex flex-wrap mb-3 -mx-1">
                                <template v-for="(day, index) in days" >
                                    <div style="width: 14.26%" class="px-1" :key="index">
                                        <div v-text="day" class="text-gray-800 font-medium text-center text-xs"></div>
                                    </div>
                                </template>
                            </div>
