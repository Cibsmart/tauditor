<template>
  <div>
    <div
      ...
      class="mb-8 rounded-md bg-green-50 p-4"
    >
      <div class="flex">
    ...
    <div
      v-if="
        ...
        show
      "
      class="mb-8 rounded-md bg-red-50 p-4"
    >
      <div class="flex">
        <div class="flex-shrink-0">
          <svg
        ...
        <div class="ml-3">
          <div class="text-sm leading-5 font-medium text-red-800">
            <span v-if="$page.props.flash.error" class="py-4 text-sm">{{
              $page.props.flash.error
            }}</span>
        ...
        <div class="ml-auto pl-3">
          <div class="-mx-1.5 -my-1.5">
            <button
              @click="show = false"
              class="inline-flex rounded-md p-1.5 text-red-500 transition duration-150 ease-in-out hover:bg-red-100 focus:bg-red-100 focus:outline-none"
            >
              <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path
                  fill-rule="evenodd"
