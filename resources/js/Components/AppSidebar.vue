            ...
            <SidebarMenu>
                <SidebarMenuItem>
                    <SidebarMenuButton :as="Link" href="/" class="h-10">
                        <Logo class="h-5 w-5 text-primary shrink-0" />
                        <span class="font-semibold text-sm truncate">TAuditor</span>
                    </SidebarMenuButton>
                </SidebarMenuItem>
            </SidebarMenu>
        </SidebarHeader>
                        ...
                        <DropdownMenuTrigger as-child>
                            <SidebarMenuButton class="h-12">
                                <div class="flex flex-col text-left leading-tight min-w-0">
                                    ...
                                    <span class="text-xs text-sidebar-foreground/60 truncate">
                                        {{ user.domain.name }}
                                    </span>
                                </div>
                                <ChevronsUpDown class="ml-auto h-4 w-4 shrink-0 text-sidebar-foreground/50" />
                            </SidebarMenuButton>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent side="top" align="start" class="w-56">
                            <DropdownMenuLabel class="font-normal">
                                <div class="flex flex-col gap-0.5">
                                    ...
                                    <span class="text-xs text-muted-foreground">{{ user.domain.name }}</span>
                                </div>
                            </DropdownMenuLabel>
                            <DropdownMenuSeparator />
                            ...
                            <DropdownMenuItem v-if="permissions.canViewUsers" as-child>
                                <Link :href="route('manage_users.index')" class="flex items-center gap-2 cursor-pointer">
                                    Manage Users
                                </Link>
                            </DropdownMenuItem>
                            <DropdownMenuSeparator />
