<template>
  ...
  <form class="mt-8 rounded-lg shadow-lg overflow-hidden" @submit.prevent="submit">
    <div class="px-10 py-12">
      ...
      <label-input :model-value="user.first_name" class="mt-10" label="First Name" />

      <label-input :model-value="user.last_name" class="mt-10" label="Last Name" />
      ...
      <text-input v-model="form.password_confirmation" :errors="form.errors.password_confirmation" class="mt-6"
