<template>
  <div>
    ...
    <div class="mb-6 flex justify-between items-center">
      <div></div>
      <Button :as="Link" :href="route('audit_payroll.store')" method="post" preserve-state size="lg">
      ...
      <Table>
        ...
        <TableBody v-for="payroll in payrolls.data" :key="payroll.id">
          <TableRow :key="payroll.id">
            ...
            <TableCell class="w-px">
              <Button :as="Link" href="#" preserve-state size="sm"
                      variant="outline" @click.prevent="showModal(payroll.id)">
                Add Schedule
              </Button>
            </TableCell>
                ...
                <TableBody>
                  ...
                  <TableRow v-for="category in payroll.other_categories" :key="category.id">
                    ...
                    <TableCell class="text-right">
                      ...
                      <form v-else :key="category.id" @submit.prevent="upload(category.id)">
                        <div class="flex items-center">
                          <file-input v-model="file.schedule_file[category.id]"
                                      :errors="file.errors.schedule_file" accept="file/*" class="pr-6 w-full"
                                      type="file" />
        ...
        <TableBody>
          <TableRow v-if="payrolls.data.length === 0">
            <TableCell class="text-xs font-medium text-gray-700 uppercase tracking-wider" colspan="3">
              No Payroll
            </TableCell>
          </TableRow>
        </TableBody>
    ...
    <div v-if="showCreateModal" aria-modal="true" class="fixed z-10 inset-0 overflow-y-auto" role="dialog">
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div class="fixed inset-0 bg-gray-500 bg-opacity-75" @click="closeModal"></div>
        <div
          class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
              ...
              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div class="mt-5">
                  <select-input v-model="form.payment_type_id" :errors="form.errors.payment_type_id"
                    ...
                    <option class="text-gray-100" disabled value="">Select Payment Type</option>
                  ...
                  <fieldset class="flex justify-between">
                    ...
                    <div class="relative flex items-start">
                      <div class="flex items-center h-5">
                        <input id="paycomm_tenece" v-model="form.paycomm_tenece"
                      ...
                      <div class="ml-3 text-sm">
                        <label class="font-medium text-gray-700" for="paycomm_tenece">Apply Charges</label>
                    ...
                    <div v-if="form.paycomm_tenece" class="relative flex items-start">
                      <div class="flex items-center h-5">
                        <input id="paycomm_fidelity" v-model="form.paycomm_fidelity"
                      ...
                      <div class="ml-3 text-sm">
                        <label class="font-medium text-gray-700" for="paycomm_fidelity">Apply Fidelity Charges</label>
          ...
          <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <Button class="sm:ml-3" type="button" variant="outline" @click="closeModal">
              Cancel
            </Button>
          </div>
        </div>
