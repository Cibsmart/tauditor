                                    ...
                                    >
                                        ...
                                        <TableCell class="text-right">
                                            <Button
                                                ...
                                                :href="
                                                    route(
                                                        'other_audit_autopay.generate',
                                                        {
                                                            other_audit_payroll_category:
                                                                category.id,
                                                        },
                                                    )
                                                "
                                            ...
                                            <a
                                                ...
                                                :href="
                                                    route(
                                                        'other_audit_autopay.downloadMfb',
                                                        {
                                                            other_audit_payroll_category:
                                                                category.id,
                                                        },
