...
<!--                                <inertia-link v-if="schedule.generated && schedule.uploaded" href="#" class="px-5 py-3">-->
<!--                                    View Details-->
<!--                                </inertia-link>-->

                                <form v-if="schedule.generated && ! schedule.uploaded" @submit.prevent="upload(schedule.sub_mda_id, schedule.mda_name)" :key="schedule.id">
                                ...
                                <form v-else-if="schedule.generated && schedule.uploaded" @submit.prevent="reupload(schedule.sub_mda_id, schedule.mda_name)" :key="schedule.id">
                                    <div class="px-5 flex items-center justify-end">
...
<script>
    ...
    export default {
        metaInfo: { title: 'Autopay Sub MDA Schedules' },
        layout: Layout,
