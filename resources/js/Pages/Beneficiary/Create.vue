                ...
                <form class="w-full max-w-lg m-auto">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-date-of-birth" type="date" placeholder="Date of Birth">
                    ...
                    <div class="md:flex md:items-center">           
                        <div class="md:w-1/3">
                            ...
                            <button class="hover:bg-blue-500 px-6 py-3 flex items-center rounded bg-indigo-800 text-white text-sm font-bold whitespace-no-wrap">
                              Add Beneficiary
                            </button>
                        </div>
                    </div>
