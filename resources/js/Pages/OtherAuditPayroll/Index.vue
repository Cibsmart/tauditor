<template>
    <div>
        <h1 class="mb-8 font-bold text-3xl">Other Audit Payrolls</h1>
                    ...
                    <table class="min-w-full">
                        ...
                        <tr :key="payroll.id" class="hover:bg-gray-100 focus-within:bg-gray-100">
                            ...
                            <td class="w-px whitespace-no-wrap border-b border-gray-200">
                                <Link href="#" @click.prevent="showModal(payroll.id)"
                                      class="btn btn-small text-white bg-indigo-400" preserve-state>
                                    Add Schedule
                                </Link>
                            </td>
...
export default {
    metaInfo: {title: 'Other Audit Payroll'},
    layout: Layout,
