<template>
  <div>
    ...
    <h1 class="mb-8 text-3xl font-bold">Audit Analysis</h1>
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell class="text-right">
                      <Button
                        v-show="category.analysable"
                        :as="Link"
                        :href="
                          route('audit_analysis.analyse', {
                      ...
                      <span v-show="category.analysable && category.viewable">
                        |
                      </span>
